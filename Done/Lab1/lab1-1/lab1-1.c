...
//gcc lab1-1.c ../common/*.c ../common/*.m -framework OpenGL -framework Cocoa -o lab1-1 -I../common
...
GLuint phongshader = 0, plaintextureshader = 0, lowpasshader = 0, bloom = 0, brightness = 0;
...
void init(void)
{
	...
	lowpasshader = loadShaders("plaintextureshader.vert", "lowpass.frag");
	brightness = loadShaders("plaintextureshader.vert", "brightness.frag");
	bloom = loadShaders("plaintextureshader.vert", "bloom.frag");
...
//	model1 = LoadModelPlus("train.obj");
...
void display(void)
{
	...
	glUniform1i(glGetUniformLocation(phongshader, "texUnit2"), 1);
	...
	useFBO(fbo2, fbo1, 0L);
	glUseProgram(brightness);

	glClearColor(0.0, 0.0, 0.0, 0);
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	glDisable(GL_CULL_FACE);
	glDisable(GL_DEPTH_TEST);
	DrawModel(squareModel, brightness, "in_Position", NULL, "in_TexCoord");
...
//	glFlush(); // Can cause flickering on some systems. Can also be necessary to make drawing complete.
	...
	useFBO(fbo3, fbo1, fbo2);	      
	glUseProgram(bloom);
	glClearColor(0.0, 0.0, 0.0, 0);
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	glDisable(GL_CULL_FACE);
	glDisable(GL_DEPTH_TEST);
	DrawModel(squareModel, bloom, "in_Position", NULL, "in_TexCoord");
